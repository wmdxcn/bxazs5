...
echo "防火墙配置"
iptables -t nat -I POSTROUTING -p all -s 172.10.107.0/24 -j SNAT --to-source 10.0.0.5
iptables -t nat -I POSTROUTING -p all -s 172.10.108.0/24 -j SNAT --to-source 10.0.0.6
